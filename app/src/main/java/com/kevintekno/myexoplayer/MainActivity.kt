package com.kevintekno.myexoplayer
...
import com.kevintekno.myexoplayer.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun hideSystemUI() {
        ...
        WindowInsetsControllerCompat(window, binding.mediaPlayer).let { controller ->
